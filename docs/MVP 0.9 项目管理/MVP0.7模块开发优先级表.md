...
| 2 | P0.5 | GUI-P0-02B 天命 + 人口阶段 GUI 闭环 | SA 已定稿/已派工 | SA `READY_FOR_TECH_TASK`；技术任务书已发布给 CGT-01；复用 GUI-P0-01 人口切片，并通过窄范围 `MortalityService`/`mortality_api` 补齐天命阶段 GUI 安全入口 |
| 3 | P0.5 | GUI-P0-02C 元老院阶段 GUI 闭环 | 待排期 | 承接 PoliticalSystem/senate_api，保护投票、提案、任命等边界 |
