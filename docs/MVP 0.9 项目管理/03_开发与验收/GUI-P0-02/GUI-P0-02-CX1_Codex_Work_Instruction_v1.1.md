# CODEX Work Instruction — GUI-P0-02-CX1 v1.1
...
The GUI has already undergone multiple repair attempts.

Do not assume that the previous diagnosis is correct.

Treat all earlier conclusions as hypotheses only.

The latest runtime screenshot is the source of truth.

Code changes must be derived from runtime evidence, not from implementation assumptions.

---

## Background

OpenClaw / DA previously attempted to repair the missing central page information hierarchy by modifying:
...
Reference visual files to be provided with this task:

- approved Phase 1 design screenshot
- latest actual runtime screenshot
...
The task is not another cosmetic adjustment.
...
The fix must be minimal and evidence-based.
