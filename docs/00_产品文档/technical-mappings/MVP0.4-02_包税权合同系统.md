...
| 版本 | 日期 | 摘要 |
|:-----|:-----|:------|
| v1.4 | 2026-08-29 | WP-F 003（S1-8）：`economic_service.collect_private_land_income` 地主行补 `faction_id`（fig.faction_id，None 允许）；RevenueStage 地主姓名经 FactionStyle 着色（None → fallback #3A3530） |
